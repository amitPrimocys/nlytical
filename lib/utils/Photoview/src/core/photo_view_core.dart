...
import 'package:nlytical/utils/Photoview/photo_view.dart'
    show
        ...
        ScaleStateCycle;
import 'package:nlytical/utils/Photoview/src/controller/photo_view_controller.dart';
import 'package:nlytical/utils/Photoview/src/controller/photo_view_controller_delegate.dart';
import 'package:nlytical/utils/Photoview/src/controller/photo_view_scalestate_controller.dart';
import 'package:nlytical/utils/Photoview/src/core/photo_view_gesture_detector.dart';
import 'package:nlytical/utils/Photoview/src/core/photo_view_hit_corners.dart';
import 'package:nlytical/utils/Photoview/src/utils/photo_view_utils.dart';
...
class PhotoViewCoreState extends State<PhotoViewCore>
  ...
  void onScaleEnd(ScaleEndDetails details) {
    ...
    if (scale > maxScale) {
      final double scaleComebackRatio = maxScale / scale;
    ...
    if (scale < minScale) {
      final double scaleComebackRatio = minScale / scale;
      animateScale(scale, minScale);
      animatePosition(
        position,
        clampPosition(position: position * scaleComebackRatio, scale: minScale),
      );
      return;
    }
